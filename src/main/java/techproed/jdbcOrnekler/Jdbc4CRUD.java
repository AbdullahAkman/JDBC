...
//		
//	PreparedStatement veri=	con.prepareStatement("INSERT INTO urunler VALUES(?,?,?)");// mySQL bağlantına gizli bir alan ac,3 verilik bir alan ac
//	
...
//		
//		veri.addBatch(); // hepsini topla tek veri haline getir
//			}
...
//	
	...
	ORNEK4: urunler tablosuna Marka adinda ve Default degeri ASUS olan yeni 
	 bir sutun ekleyiniz.--> bu işlem bir alter işlemidir..
	========================================================================*/
//	st.executeUpdate("ALTER TABLE urunler ADD marka VARCHAR(10) DEFAULT 'ASUS'");
//	System.out.println("istenen sutun eklendi");
	...
	/*=======================================================================
	 ...
	 ========================================================================*/ 
		...
		System.out.println("istenen tablo silindi");
