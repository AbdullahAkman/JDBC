...
//		========================================================================*/ 
		...
		ResultSet tablo= st.executeQuery("SELECT * FROM bolumler");// bolumler tablosunu mySQL'den getirdi..bunu birseye atayacagız
...
//		========================================================================*/ 
		/*String sorgu =("SELECT personel_isim, maas "
				+ " FROM personel "
				+ " WHERE bolum_id in (10,30)" 
				+ " ORDER BY maas DESC"); bu şekilde diger kısımlarda atama yapılarak kullanılabilir*/
